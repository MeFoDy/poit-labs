...
var
        ...
        lm:word;
const
        v:array[1..4] of string[35]=('Математика','Программирование','Сети','Oперационные Cистемы');
        s:array[1..4,1..2] of byte=((3,7),(12,15),(15,17),(23,41));
        p:array[1..4,1..2] of string[35]=(('Алгебра','Геометрия'),('ООП','Процедуры'),('Интернет','Локальная сеть'),
        ('Windows','Linux'));
        s2:array[1..4,1..2,1..2] of byte=(((3,9),(18,21)),((19,60),(28,39)),((34,50),(41,51)),((49,50),(53,66)));
        pp:array[1..4,1..2,1..2] of string[35]=((('Векторы','Матрицы'),('Евклидова геометрия','Поверхности')),
        (('Инкапсуляция','Полиморфизм'),('Юниты','Модули')),
                                          (('Космос-ТВ','Белтелеком'),('Атлант','TCM')),
                                          (('Windows XP','Windows 7'),('Ubuntu','MAC')));
