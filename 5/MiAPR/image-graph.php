...
function draw_data($x,$y,$rad,$color, $isCore = false)
{
	...
	$color = array (
					...
					,0 => ImageColorAllocate ($im, 115, 255, 100)
					,1 => ImageColorAllocate ($im, 255, 0, 0)
					,2 => ImageColorAllocate ($im, 0, 0, 255)
					,3 => ImageColorAllocate ($im, 255, 255, 0)
					,4 => ImageColorAllocate ($im, 255, 0, 255)
					,5 => ImageColorAllocate ($im, 0, 255, 255)
					,6 => ImageColorAllocate ($im, 0, 150, 0)
					,7 => ImageColorAllocate ($im, 120, 0, 0)
					,8 => ImageColorAllocate ($im, 0, 0, 120)
					,9 => ImageColorAllocate ($im, 120, 120, 0)
					,10 => ImageColorAllocate ($im, 120, 0, 120)
					,11 => ImageColorAllocate ($im, 0, 120, 120));
